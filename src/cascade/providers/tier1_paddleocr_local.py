...
#: ``alias_table_seed.json`` path. Lives at the **repo root** (not under
#: ``src/``) by canonical-artifact contract — see memory project_src_layout.
ALIAS_TABLE_PATH = repo_root() / "alias_table_seed.json"
