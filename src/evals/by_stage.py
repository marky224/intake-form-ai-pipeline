...
#: Committed by-stage chart artifact under repo-root ``docs/assets/`` (docs/
#: stays at the repo root, not under src/ — see memory project_src_layout).
BY_STAGE_CHART_PATH = repo_root() / "docs" / "assets" / "f1-by-stage.svg"
