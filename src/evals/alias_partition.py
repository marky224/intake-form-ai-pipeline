...
#: The canonical, full seed. Lives at the **repo root** (not under src/) by
#: canonical-artifact contract — see memory project_src_layout.
ALIAS_SEED_PATH = repo_root() / "alias_table_seed.json"
